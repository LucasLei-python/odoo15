...
%(fields_list)s""") % {
    ...
    def write(self, vals):
        ...
        * .. _openerp/models/relationals/format:
        ...
        if self._log_access:
            vals.setdefault('write_uid', SUPERUSER_ID)
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            ...
            for name in bad_names:
                vals.pop(name, None)
            if self._log_access:
                vals.setdefault('create_uid', SUPERUSER_ID)
    ...
    def sudo(self, flag=True):
        ...
        return self.with_env(self.env(su=flag,user=SUPERUSER_ID))
    ...
    def with_user(self, user):
        ...
        return self.with_env(self.env(user=SUPERUSER_ID, su=False))
